...
int main(int argc, char **argv) {
  ...
  double init_coords[15]={18.601341,5.863605,41.719978,49.030365,40.241982,6.42026,40.625458,7.102573,18.628273,37.407841,16.827398,8.456863,2.355484,17.931345,17.61512};
  double receive_coords[15];
  double diff;
  double d_conv;
  ...
  try
  {
    ...
    MDI_Recv(&receive_coords,15,MDI_DOUBLE,LAMMPS_comm);

    MDI_Send_Command(">COORDS",LAMMPS_comm);
    MDI_Send(&receive_coords,15,MDI_DOUBLE,LAMMPS_comm);
